...
<div class="row table-responsive" id="events-row">
            ...
            <div class="d-block d-md-none">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                  ...
                  <li>
                    <?= anchor(base_url("events/delete/" . $event['idevents']), '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
