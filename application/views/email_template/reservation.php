...
<img src=<?= base_url() . 'assets/images/royal-g-logo.png ' ?>
<!--[if mso]></td></tr></table><![endif]-->
</div>
<!--[if (!mso)&(!IE)]><!-->
</div>
...
<p style="margin: 0; font-size: 14px; line-height: 1.2; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;"><p
	style="
	  margin: 0;
	  font-size: 14px;
	  line-height: 1.2;
